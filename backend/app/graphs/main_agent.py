...
SYSTEM_PROMPT = (
    ...
    "like `...`.\n"
    "To plot data, call `python_exec` and use matplotlib. End your script with "
    "`out_image(plt.gcf(), title='...')` (or just `out_image()`) — that emits "
    "the figure as an image artifact. Don't try to embed plots as markdown.\n"
